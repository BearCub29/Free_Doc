...
ActiveRecord::Schema.define(version: 2020_02_06_112617) do
  ...
  create_table "connects", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["doctor_id"], name: "index_connects_on_doctor_id"
    t.index ["specialty_id"], name: "index_connects_on_specialty_id"
  end
